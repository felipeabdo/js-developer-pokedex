...
// Aqui criamos uma função getPokemons dentro do objeto pokeAPI que criamos acima.

pokeApi.getPokemons = (offset = 0, limit = 10) => { // nossa função getPokemons começa com um default de offset e limit.
